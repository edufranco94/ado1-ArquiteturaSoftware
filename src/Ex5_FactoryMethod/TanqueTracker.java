 ...
 * @author Edu Franco
 */
public class TanqueTracker extends Tanque {

    public TanqueTracker() {
    }
    ...
    @Override
    public void atirar() {
        System.out.println("Tracker disparando a 250metros de distancia!");
    }

    @Override
    public void caracteristicasTanque() {
        System.out.println("Tanque escolhido: Tracker");
